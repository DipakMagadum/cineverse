    ...
    <div className="bg-[#0f0f0f] min-h-screen text-white">
      ...
      <div className="px-6 md:px-10 pt-24 pb-10">
        <h1 className="text-2xl font-black text-white mb-6">
          All <span className="text-[#e50914]">Movies</span>
        </h1>
        ...
        <div className="mb-4">
          <p className="text-gray-600 text-xs font-semibold mb-2 tracking-widest">
            GENRE
          </p>
        ...
        {loading ? (
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
            {[...Array(12)].map((_, i) => (
              <div
                key={i}
                className="bg-[#141414] rounded-lg overflow-hidden animate-pulse"
              >
            ...
            {movies.map((movie) => (
              ...
              >
                <div className="relative" style={{ aspectRatio: "2/3" }}>
                  ...
                  <span className="absolute top-2 left-2 bg-[#e50914] text-white text-xs px-1.5 py-0.5 rounded font-bold">
                    HD
                  </span>
                  {movie.isTrending && (
                    <span className="absolute top-2 right-2 bg-orange-600 text-white text-xs px-1.5 py-0.5 rounded font-bold">
                      🔥
                    </span>
                  )}
                </div>
                <div className="p-2.5">
                  ...
                  <span className="bg-[#1f1f1f] text-gray-500 text-xs px-1.5 py-0.5 rounded mt-1 inline-block">
                    {movie.language}
                  </span>
                </div>
              </div>
